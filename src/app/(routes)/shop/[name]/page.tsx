...
export default function Home() {
  ...
  return (
    <div className="w-full p-3 sm:p-4 md:p-5 2xl:px-12 ">
        ...
        <div className="flex flex-col w-full gap-4 lg:max-w-min lg:gap-2 xl:gap-4 xl:max-w-1/3 ">
          ...
          <div className="mt-4 lg:mt-2">
            ...
            <div className="flex items-center gap-3 my-6 sm:gap-4 sm:my-8">
              <button className="bg-scdOrang rounded-md text-white uppercase text-xs p-3 px-4 sm:text-sm sm:p-4 sm:px-5 xl:text-base ">
                Buy Now
              </button>
              <button className="bg-[#373b3e] rounded-md text-white uppercase text-xs p-3 px-4 sm:text-sm sm:p-4 sm:px-5 xl:text-base">
                Add to cart
              </button>
            </div>
          </div>
        ...
        <div className="flex text-btnGray gap-3">
          ...
          <div className="">
            ...
            <p className="max-w-[46vw] text-xs leading-4 sm:leading-5  sm:text-sm lg:text-base lg:leading-7  ">
              ...
              scelerisque amet. Bibendum adipiscing platea blandit.
            </p>
          </div>
        </div>
        <div className="flex text-btnGray gap-3">
      ...
      <div className="my-24 mb-4 ">
      <TitleSection LastSlide={()=>goToNextSlide(ProductswiperRef)} NextSlide={()=>goToPrevSlide(ProductswiperRef)} title="Related Products" />
      <div className="my-3 mb-6 md:my-9 md:mb-11 lg:my-10 lg:mb-12">
      <SwiperComponent children={TradProducts} gap={20} swiperRef={ProductswiperRef} 
      spacebetween={size.width && size.width >= 1536 ? 15 : size.width >=768 ? 15 : 10}
      slidesperView={size.width && (size.width >= 1536 ? 5 : (size.width>=1024 ? 4 : (size.width>=768 ? 3 : size.width>=600 ? 2 : 1)))}
       />
      </div>
      </div>
    </div>
